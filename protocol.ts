...
export type RelayEvent<TPayload = unknown> =
	...
	{ type: typeof EVENT_TYPE.leave; } |
	{ type: typeof EVENT_TYPE.closeRoom; } |
	...
	{ type: typeof EVENT_TYPE.joined;        serverTime: number; roomId: string; memberId: string; resumeToken: string; resumed: boolean; displayName: string; roomMode: RoomMode; role: MemberRole; members: MemberInfo[]; } |
	...
	{ type: typeof EVENT_TYPE.memberUpdated; serverTime: number; roomId: string; memberId: string; displayName: string; state: MemberState; members: MemberInfo[]; } |
